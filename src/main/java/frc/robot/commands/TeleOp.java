...
public class TeleOp extends Command {
  ...
  /** Creates a new TeleOp. */
  public TeleOp(Turret turret, Intake intake, Shooter shooter, BeltIndexer beltIndexer, Shooter servoHub, ServoChannel servoLeft, ServoChannel servoRight, Climb climber) {
