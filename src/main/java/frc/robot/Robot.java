...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    // TODO: ensure alliance detection runs properly when running from the DS and
    // the FMS
    ...
    if (alliance.isPresent()) {
      ...
      if (alliance.get() == Alliance.Red) {
        ...
        validTagsPresent = false;
      }
      LimelightHelpers.SetFiducialIDFiltersOverride("", valid);
      SmartDashboard.putBoolean("Valid Tags Loaded", validTagsPresent);
    }
