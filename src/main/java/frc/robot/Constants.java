...
public final class Constants {
  ...
  public static class Identification {
    ...
    public static class BeltIndexerConstants {
        public static final double beltIndexerVoltage = 9;
    }
  ...
  public static class SchloopConstants {
    public static final double schloopVoltage = 4;
  }
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 5.3; // max is 6.77
